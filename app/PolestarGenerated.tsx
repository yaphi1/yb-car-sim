...
-
Heavily modified manually to integrate with physics
*/
...
export function PolestarGenerated({
  color = 0x5500aa,
  speed = 0,
  chassisBodyRef,
  carRenderPosition,
  ...
  const { nodes, materials } = useGLTF('/models/polestar_modified/scene.gltf') as GLTFResult;
      ...
      <group ref={chassisBodyRef} {...props} dispose={null}>
        <group>
          ...
          >
            ...
            <mesh geometry={nodes.Polestar_1_Polestar_1_Car_Paint_0.geometry} material={carPaint} />
...
useGLTF.preload('/models/polestar_modified/scene.gltf');
